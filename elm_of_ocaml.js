...
(function(joo_global_object_B_)
   {"use strict";
    var
     ...
     num_1e3_W_=1e3,
      /*<<stdlib.js 1025 20>>*/ caml_oo_last_id_a$_=0;
     /*<<stdlib.js 1036 0>>*/ function caml_fresh_oo_id_n_()
     { /*<<stdlib.js 1037 2>>*/ return caml_oo_last_id_a$_++ /*<<stdlib.js 1038 0>>*/ }
     /*<<mlString.js 50 0>>*/ function caml_str_repeat_bd_(n_a_,s_b_)
     ...
     { /*<<mlString.js 251 2>>*/ if(s_a_.t==2)
       s_a_.c+=
        /*<<mlString.js 252 11>>*/ caml_str_repeat_bd_
     ...
     /*<<mlString.js 115 0>>*/ function caml_utf16_of_utf8_bi_(s_a_)
     ...
     /*<<mlString.js 174 0>>*/ function caml_to_js_string_bh_(s_a_)
     { /*<<mlString.js 175 2>>*/ switch(s_a_.t)
       {case 9: /*<<mlString.js 177 4>>*/ return s_a_.c;
        default:
         ...
         s_a_.t=8;
        case 8:
          /*<<mlString.js 187 4>>*/ return  /*<<mlString.js 187 11>>*/ caml_utf16_of_utf8_bi_
                 (s_a_.c)
        } /*<<mlString.js 189 0>>*/ }
    ...
    function()
     { /*<<mlString.js 245 41>>*/ return  /*<<mlString.js 245 48>>*/ caml_to_js_string_bh_
     ...
     /*<<mlString.js 80 0>>*/ function caml_utf8_of_utf16_bj_(s_a_)
     ...
     { /*<<mlString.js 286 10>>*/ var tag_b_=9;
       ...
       tag_b_=8,s_a_= /*<<mlString.js 288 41>>*/ caml_utf8_of_utf16_bj_(s_a_);
       /*<<mlString.js 289 2>>*/ return new
              MlString_h_
              (tag_b_,s_a_,s_a_.length) /*<<mlString.js 290 0>>*/ }
     /*<<stdlib.js 125 0>>*/ function caml_raise_with_arg_ba_(tag_a_,arg_b_)
     ...
     (tag_a_,msg_b_)
     { /*<<stdlib.js 130 2>>*/ caml_raise_with_arg_ba_
     ...
     /*<<io.js 346 0>>*/ function caml_ml_flush_a6_(oc_a_)
    ...
    {truncate:
     ...
     modified:
     function()
      { /*<<fs.js 64 12>>*/ var now_a_= /*<<fs.js 64 14>>*/ unix_time_C_();
       this.atime=now_a_;
     ...
     /*<<fs.js 23 21>>*/ var caml_current_dir_a4_=str_P_;
     /*<<fs.js 107 0>>*/ function caml_make_path_r_(name_a_)
     {name_a_=
      name_a_ instanceof MlString_h_
       ? /*<<fs.js 108 34>>*/ name_a_.toString()
       :name_a_;
       /*<<fs.js 109 2>>*/ if( /*<<fs.js 109 5>>*/ name_a_.charCodeAt(0)!=47)
       name_a_=caml_current_dir_a4_+name_a_;
      var
     ...
     {this.content={};
      this.inode=file_inode_as_++;
       /*<<fs.js 31 26>>*/ var now_a_= /*<<fs.js 31 28>>*/ unix_time_C_();
      this.atime=now_a_;
      this.mtime=now_a_;
    ...
    {exists:
     ...
     /*<<fs.js 72 18>>*/ var caml_root_dir_t_=new MlDir_j_();
     /*<<fs.js 73 0>>*/ caml_root_dir_t_.mk(str_d_,new MlDir_j_());
     /*<<fs.js 181 0>>*/ function caml_fs_content_y_(path_a_)
     { /*<<fs.js 182 10>>*/ var dir_b_=caml_root_dir_t_;
       /*<<fs.js 183 2>>*/ for
     ...
     /*<<fs.js 256 0>>*/ function caml_sys_is_directory_bg_(name_a_)
     {var
        /*<<fs.js 257 11>>*/ path_c_=
         /*<<fs.js 257 13>>*/ caml_make_path_r_(name_a_),
        /*<<fs.js 258 10>>*/ dir_b_=
         /*<<fs.js 258 12>>*/ caml_fs_content_y_(path_c_);
       /*<<fs.js 259 2>>*/ return dir_b_ instanceof MlDir_j_?1:0 /*<<fs.js 260 0>>*/ }
     /*<<mlString.js 303 0>>*/ function caml_string_of_array_be_(a_a_)
     ...
     /*<<mlString.js 271 0>>*/ function caml_array_of_string_bn_(s_a_)
     ...
     /*<<fs.js 133 0>>*/ function caml_fs_register_a5_(name_a_,content_b_)
     {var
        /*<<fs.js 134 11>>*/ path_f_=
         /*<<fs.js 134 13>>*/ caml_make_path_r_(name_a_),
        /*<<fs.js 135 10>>*/ dir_d_=caml_root_dir_t_;
       /*<<fs.js 136 2>>*/ for
       ( /*<<fs.js 136 11>>*/ var i_k_=0;i_k_<path_f_.length-1;i_k_++)
        ...
        dir_d_= /*<<fs.js 140 10>>*/ dir_d_.get(d_e_);
         /*<<fs.js 141 4>>*/ if(!(dir_d_ instanceof MlDir_j_))
          ...
          (path_f_.orig+str_file_already_abr_x_)}
         ...
         /*<<fs.js 148 7>>*/ if(content_b_ instanceof MlString_h_)
          ...
          /*<<fs.js 149 7>>*/ if(content_b_ instanceof Array)
           ...
           (d_e_,
            new
             MlFile_i_
             ( /*<<fs.js 149 56>>*/ caml_string_of_array_be_(content_b_)));
         else
     ...
     /*<<fs.js 192 0>>*/ function caml_sys_file_exists_bf_(name_a_)
     {var
        /*<<fs.js 193 10>>*/ dir_b_=caml_root_dir_t_,
        /*<<fs.js 194 11>>*/ path_d_=
         /*<<fs.js 194 13>>*/ caml_make_path_r_(name_a_),
       auto_load_e_,
       pos_f_;
       /*<<fs.js 197 2>>*/ for
     ...
     /*<<io.js 45 0>>*/ function caml_sys_open_bo_(name_a_,flags_b_,perms_c_)
     { /*<<io.js 46 8>>*/ var f_d_={};
      ...
      var
        ...
        /*<<io.js 62 11>>*/ path_j_=
         /*<<io.js 62 13>>*/ caml_make_path_r_(name_a_);
       ...
       /*<<io.js 67 2>>*/ if
       ( /*<<io.js 67 6>>*/ caml_sys_file_exists_bf_(name_a_))
        /*<<io.js 67 34>>*/ { /*<<io.js 68 4>>*/ if
         ( /*<<io.js 68 8>>*/ caml_sys_is_directory_bg_(name_a_))
         ...
         /*<<io.js 69 4>>*/ if(f_d_.create&&f_d_.excl)
          ...
          (name2_h_+str_file_already_abr_x_);
        var
          /*<<io.js 70 12>>*/ idx_i_=
          caml_global_data_f_.fd_last_idx?caml_global_data_f_.fd_last_idx:0,
          /*<<io.js 71 13>>*/ file_e_=
           /*<<io.js 71 15>>*/ caml_fs_content_y_(path_j_);
        ...
        /*<<io.js 74 9>>*/ if(f_d_.create)
         /*<<io.js 74 23>>*/ { /*<<io.js 75 12>>*/ var
          idx_i_=
           caml_global_data_f_.fd_last_idx?caml_global_data_f_.fd_last_idx:0;
          /*<<io.js 76 4>>*/ caml_fs_register_a5_
          (name_a_, /*<<io.js 76 26>>*/ caml_create_string_l_(0));
          /*<<io.js 77 13>>*/ var
          file_e_=
            /*<<io.js 77 15>>*/ caml_fs_content_y_(path_j_);
     ...
     /*<<io.js 153 0>>*/ function caml_ml_open_descriptor_in_a7_(fd_a_)
     ...
     /*<<jslib.js 91 0>>*/ function js_print_stdout_bk_(s_a_)
     { /*<<jslib.js 94 2>>*/ if
     ...
     /*<<io.js 95 25>>*/ var caml_ml_out_channels_s_=new Array();
     /*<<io.js 113 0>>*/ function caml_std_output_bc_(chan_a_,s_b_)
     {var
        /*<<io.js 114 10>>*/ str_h_=
         /*<<io.js 114 12>>*/ caml_new_string_c_(s_b_),
        /*<<io.js 115 11>>*/ slen_d_=
         /*<<io.js 115 13>>*/ caml_ml_string_length_z_(str_h_),
        /*<<io.js 116 11>>*/ clen_g_=
         /*<<io.js 116 13>>*/ caml_ml_string_length_z_(chan_a_.file.data),
     ...
     {var output_b_;
       ...
       {case 1:output_b_=js_print_stdout_bk_; /*<<io.js 132 35>>*/ break;
        case 2:output_b_=js_print_stderr_at_; /*<<io.js 133 35>>*/ break;
        default:output_b_=caml_std_output_bc_}
     ...
     /*<<io.js 99 0>>*/ function caml_ml_out_channels_list_a8_()
     { /*<<io.js 100 8>>*/ var l_a_=0;
       /*<<io.js 101 2>>*/ for(var c_b_ in caml_ml_out_channels_s_)
        /*<<io.js 101 36>>*/ if(caml_ml_out_channels_s_[c_b_].opened)
        l_a_=[0,caml_ml_out_channels_s_[c_b_],l_a_];
       /*<<io.js 105 2>>*/ return l_a_ /*<<io.js 106 0>>*/ }
     /*<<stdlib.js 210 0>>*/ function caml_obj_tag_a__(x_a_)
     ...
     /*<<stdlib.js 76 22>>*/ var caml_named_values_a9_={};
     /*<<mlString.js 278 0>>*/ function caml_bytes_of_string_a3_(s_a_)
     ...
     /*<<stdlib.js 80 0>>*/ function caml_register_named_value_bb_(nm_a_,v_b_)
     {caml_named_values_a9_
       [ /*<<stdlib.js 81 20>>*/ caml_bytes_of_string_a3_(nm_a_)]=
      v_b_;
    ...
    caml_ml_open_descriptor_in_a7_(0);
    ...
    var
     ...
     _a0_=caml_new_string_c_("+"),
     _a1_=caml_new_string_c_("-"),
     _aX_=caml_new_string_c_("hello");
    function _E_(_a_){ /*<<?>>*/ _D_[1]=[0,_a_,_D_[1]];return 0}
    var
     _aw_=joo_global_object_B_.Array,
     _F_=[num_248_a_,_ax_,caml_fresh_oo_id_n_(0)],
     _u_=[0,_F_,{}],
     _av_=caml_obj_tag_a__(_u_)===num_248_a_?_u_:_u_[1];
    caml_register_named_value_bb_(caml_new_string_c_("jsError"),_av_);
    _E_
     (function(_a_)
       { /*<<?>>*/ return _a_[1]===_F_
    ...
    function _I_(_a_,_b_)
     {var _d_=_b_,_c_=_a_;
      for(;;)
       {if(_c_){var _e_=_c_[2],_d_=_H_(_d_,_c_[1]),_c_=_e_;continue}
        return _d_}}
    function _q_(_a_){ /*<<?>>*/ return _k_(_aH_,_a_)}
    var _J_=_k_(_aM_,0),_aO_=_k_(_aN_,0);
    function _K_(_a_,_b_,_c_){ /*<<?>>*/ return _G_(_aI_,_a_,_b_,_c_)}
    function _L_(_a_,_b_){ /*<<?>>*/ return _K_(_aP_,_a_,_b_)}
    function _v_(_a_,_b_){ /*<<?>>*/ return _K_(_aQ_,_a_,_b_)}
    _I_(_aT_,_aA_);
    _I_(_aU_,_aF_);
    _H_(_aV_,_aC_);
    function _w_(_a_){ /*<<?>>*/ return _G_(_aK_,_aW_,_aJ_,_k_(_aG_,_a_))}
    var _M_={},_aY_=[0,_q_(_aX_),0];
    _v_([0,_w_(0),0],_aY_);
    function _aZ_(_a_)
     {var
       _b_=[0,_q_(_a0_),0],
       _e_=[0,_v_([0,_w_(0),0],_b_),0],
       _f_=[0,_L_(0,[0,_q_(caml_new_string_c_(str_d_+_a_)),0]),_e_],
       _g_=[0,_q_(_a1_),0];
      return _L_(0,[0,_v_([0,_w_(1),0],_g_),_f_])}
    var _a2_=0;
    function _aR_(_a_){ /*<<?>>*/ return _aO_}
    function _aS_(_a_,_b_){var _c_=0===_a_?_b_+1|0:_b_-1|0;return [0,_c_,_J_]}
    _elm_lang$core$Native_Platform.addPublicModule
     (_M_,
      ...
      {"main":
       _k_
        (_aL_,
         [0,function(_a_){ /*<<?>>*/ return [0,_a2_,_J_]},_aS_,_aR_,_aZ_])});
    _M_.fullscreen();
    function _au_(_a_)
     {var _b_=_a_;
      for(;;)
       {if(_b_)
         {var _c_=_b_[2],_d_=_b_[1];
          try {caml_ml_flush_a6_(_d_)}catch(_f_){}
          var _b_=_c_;
          continue}
        return 0}}
    _au_(caml_ml_out_channels_list_a8_(0));
    return /*<<?>>*/ }
