...
(function(joo_global_object_y_)
   {"use strict";
    var
     str_Sys_error_O_="Sys_error",
     num_224_aa_=224,
     str_Invalid_argument_$_="Invalid_argument",
     num_1024_l_=1024,
     num_57343_N_=57343,
     num_512___=512,
     str_End_of_file_Z_="End_of_file",
     str_elm_lang_core_N_abr_X_="_elm_lang$core$Native_Platform.batch",
     str_Failure_Y_="Failure",
     str_Undefined_recurs_abr_M_="Undefined_recursive_module",
     str_Stack_overflow_W_="Stack_overflow",
     num_128_e_=128,
     str_d_="",
     ...
     num_2048_L_=2048,
     num_248_a_=248,
     str_Not_found_V_="Not_found",
     str_Assert_failure_H_="Assert_failure",
     str_I_="/",
     str_Sys_blocked_io_T_="Sys_blocked_io",
     str_fd_U_="fd ",
     str_Out_of_memory_G_="Out_of_memory",
     str_target_S_="target",
     str_Match_failure_R_="Match_failure",
     str_Division_by_zero_Q_="Division_by_zero",
     num_1e3_P_=1e3,
      /*<<stdlib.js 1025 20>>*/ caml_oo_last_id_aP_=0;
     /*<<stdlib.js 1036 0>>*/ function caml_fresh_oo_id_m_()
     { /*<<stdlib.js 1037 2>>*/ return caml_oo_last_id_aP_++ /*<<stdlib.js 1038 0>>*/ }
     ...
     /*<<mlString.js 70 0>>*/ function caml_subarray_to_string_x_
     (a_a_,i_b_,len_c_)
     { /*<<mlString.js 71 8>>*/ var f_e_=String.fromCharCode;
       ...
       (;0<len_c_;i_b_+=num_1024_l_,len_c_-=num_1024_l_)
       s_f_+=
        /*<<mlString.js 75 9>>*/ f_e_.apply
        (null,
          /*<<mlString.js 75 24>>*/ raw_array_sub_a1_
          (a_a_,i_b_, /*<<mlString.js 75 43>>*/ Math.min(len_c_,num_1024_l_)));
     ...
     { /*<<mlString.js 251 2>>*/ if(s_a_.t==2)
       ...
       s_a_.c=
        /*<<mlString.js 254 10>>*/ caml_subarray_to_string_x_
        (s_a_.c,0,s_a_.c.length);
      s_a_.t=0 /*<<mlString.js 256 0>>*/ }
     /*<<mlString.js 162 0>>*/ function caml_is_ascii_af_(s_a_)
     ...
     /*<<mlString.js 115 0>>*/ function caml_utf16_of_utf8_aY_(s_a_)
     { /*<<mlString.js 116 2>>*/ for
       (var
          /*<<mlString.js 116 13>>*/ b_m_=str_d_,
         ...
         /*<<mlString.js 118 4>>*/ if(c1_h_<num_128_e_)
          /*<<mlString.js 118 19>>*/ { /*<<mlString.js 119 6>>*/ for
           ( /*<<mlString.js 119 17>>*/ var j_g_=i_c_+1;
            ...
            j_g_++)
            /*<<mlString.js 119 72>>*/ ;
           /*<<mlString.js 120 6>>*/ if(j_g_-i_c_>num_512___)
            /*<<mlString.js 120 23>>*/ { /*<<mlString.js 120 25>>*/ t_f_.substr
             (0,1);
            b_m_+=t_f_;
            t_f_=str_d_;
            b_m_+= /*<<mlString.js 120 62>>*/ s_a_.slice(i_c_,j_g_)}
          else
        ...
        v_b_=1;
         ...
         (++i_c_<
          ...
          /*<<mlString.js 126 62>>*/ {c_i_=c2_j_+(c1_h_<<6);
           /*<<mlString.js 128 6>>*/ if(c1_h_<num_224_aa_)
            ...
            /*<<mlString.js 131 13>>*/ {v_b_=2;
             ...
             (++i_c_<
              ...
              /*<<mlString.js 133 66>>*/ {c_i_=c2_j_+(c_i_<<6);
               /*<<mlString.js 135 10>>*/ if(c1_h_<num_240_K_)
                /*<<mlString.js 135 25>>*/ {v_b_=c_i_-925824;
                 /*<<mlString.js 137 12>>*/ if
                 (v_b_<num_2048_L_||v_b_>=55295&&v_b_<57344)
                 v_b_=2}
              else
         ...
         /*<<mlString.js 149 4>>*/ if(v_b_<4)
          ...
          t_f_+=
           ...
           (55232+(v_b_>>10),num_56320_J_+(v_b_&1023));
         else
          t_f_+= /*<<mlString.js 155 11>>*/ String.fromCharCode(v_b_);
         /*<<mlString.js 156 4>>*/ if(t_f_.length>num_1024_l_)
          /*<<mlString.js 156 25>>*/ { /*<<mlString.js 156 26>>*/ t_f_.substr
           (0,1);
          b_m_+=t_f_;
          t_f_=str_d_}}
       /*<<mlString.js 158 2>>*/ return b_m_+t_f_ /*<<mlString.js 159 0>>*/ }
     /*<<mlString.js 174 0>>*/ function caml_to_js_string_aX_(s_a_)
     { /*<<mlString.js 175 2>>*/ switch(s_a_.t)
       {case 9: /*<<mlString.js 177 4>>*/ return s_a_.c;
        default:
          ...
          ( /*<<mlString.js 181 8>>*/ caml_is_ascii_af_(s_a_.c))
           /*<<mlString.js 181 28>>*/ {s_a_.t=9;
            /*<<mlString.js 183 6>>*/ return s_a_.c}
         s_a_.t=8;
        case 8:
          /*<<mlString.js 187 4>>*/ return  /*<<mlString.js 187 11>>*/ caml_utf16_of_utf8_aY_
                 (s_a_.c)
        } /*<<mlString.js 189 0>>*/ }
    ...
    function()
     { /*<<mlString.js 245 41>>*/ return  /*<<mlString.js 245 48>>*/ caml_to_js_string_aX_
              (this) /*<<mlString.js 245 30>>*/ };
     /*<<jslib.js 100 0>>*/ function js_print_stderr_al_(s_a_)
     { /*<<jslib.js 103 2>>*/ if
       ( /*<<jslib.js 103 5>>*/ s_a_.charCodeAt(s_a_.length-1)==10)
       s_a_= /*<<jslib.js 104 8>>*/ s_a_.substr(0,s_a_.length-1);
       /*<<jslib.js 105 8>>*/ var v_b_=joo_global_object_y_.console;
      v_b_&&v_b_.error&& /*<<jslib.js 106 18>>*/ v_b_.error(s_a_) /*<<jslib.js 107 0>>*/ }
     /*<<jslib_js_of_ocaml.js 117 0>>*/ function caml_js_expr_aJ_(s_a_)
     { /*<<jslib_js_of_ocaml.js 118 2>>*/ js_print_stderr_al_
     ...
     /*<<mlString.js 80 0>>*/ function caml_utf8_of_utf16_aZ_(s_a_)
         ...
         /*<<mlString.js 83 4>>*/ if(c_b_<num_128_e_)
          /*<<mlString.js 83 18>>*/ { /*<<mlString.js 84 6>>*/ for
           ( /*<<mlString.js 84 17>>*/ var j_g_=i_f_+1;
            ...
            j_g_++)
            /*<<mlString.js 84 71>>*/ ;
           /*<<mlString.js 85 6>>*/ if(j_g_-i_f_>num_512___)
          ...
          i_f_=j_g_}
         /*<<mlString.js 90 4>>*/ if(c_b_<num_2048_L_)
          ...
          /*<<mlString.js 93 11>>*/ if(c_b_<55296||c_b_>=num_57343_N_)
           /*<<mlString.js 93 42>>*/ t_c_+=
           /*<<mlString.js 94 11>>*/ String.fromCharCode
           (num_224_aa_|c_b_>>12,num_128_e_|c_b_>>6&63,num_128_e_|c_b_&63);
         else
           ...
           (c_b_>=
            ...
            t_c_+=
             ...
             (num_240_K_|c_b_>>18,
              ...
              num_128_e_|c_b_&63)}
         /*<<mlString.js 109 4>>*/ if(t_c_.length>num_1024_l_)
     ...
     { /*<<mlString.js 286 10>>*/ var tag_b_=9;
       ...
       (! /*<<mlString.js 287 7>>*/ caml_is_ascii_af_(s_a_))
       tag_b_=8,s_a_= /*<<mlString.js 288 41>>*/ caml_utf8_of_utf16_aZ_(s_a_);
       /*<<mlString.js 289 2>>*/ return new
              MlString_h_
              (tag_b_,s_a_,s_a_.length) /*<<mlString.js 290 0>>*/ }
     /*<<stdlib.js 125 0>>*/ function caml_raise_with_arg_aQ_(tag_a_,arg_b_)
     ...
     /*<<stdlib.js 129 0>>*/ function caml_raise_with_string_aj_
     (tag_a_,msg_b_)
     { /*<<stdlib.js 130 2>>*/ caml_raise_with_arg_aQ_
     ...
     { /*<<stdlib.js 136 2>>*/ caml_raise_with_string_aj_
       (caml_global_data_f_.Sys_error,msg_a_) /*<<stdlib.js 137 0>>*/ }
     /*<<io.js 346 0>>*/ function caml_ml_flush_aK_(oc_a_)
     ...
     { /*<<stdlib.js 172 2>>*/ caml_raise_with_string_aj_
     ...
     /*<<fs.js 25 15>>*/ var file_inode_ak_=0;
     /*<<unix.js 2 0>>*/ function unix_gettimeofday_a2_()
     { /*<<unix.js 3 2>>*/ return  /*<<unix.js 3 9>>*/ new Date().getTime()/
             num_1e3_P_ /*<<unix.js 4 0>>*/ }
     /*<<unix.js 8 0>>*/ function unix_time_z_()
     { /*<<unix.js 9 2>>*/ return  /*<<unix.js 9 9>>*/ Math.floor
              ( /*<<unix.js 9 20>>*/ unix_gettimeofday_a2_()) /*<<unix.js 10 0>>*/ }
     /*<<fs.js 51 0>>*/ function MlFile_i_(content_a_)
     {this.data=content_a_;
      this.inode=file_inode_ak_++;
       /*<<fs.js 53 34>>*/ var now_b_= /*<<fs.js 53 36>>*/ unix_time_z_();
      this.atime=now_b_;
      this.mtime=now_b_;
    ...
    {truncate:
     function()
      {this.data= /*<<fs.js 60 16>>*/ caml_create_string_k_(0);
        /*<<fs.js 61 4>>*/ this.modified() /*<<fs.js 59 11>>*/ },
     modified:
     function()
      { /*<<fs.js 64 12>>*/ var now_a_= /*<<fs.js 64 14>>*/ unix_time_z_();
       this.atime=now_a_;
       this.mtime=now_a_ /*<<fs.js 63 11>>*/ }};
     /*<<mlString.js 403 0>>*/ function caml_ml_string_length_w_(s_a_)
     { /*<<mlString.js 403 36>>*/ return s_a_.l /*<<mlString.js 403 47>>*/ }
     /*<<fs.js 93 0>>*/ function caml_raise_no_such_file_ai_(name_a_)
     {name_a_=
     ...
     /*<<fs.js 23 21>>*/ var caml_current_dir_aH_=str_I_;
     ...
     {name_a_=
      name_a_ instanceof MlString_h_
       ...
       name_a_=caml_current_dir_aH_+name_a_;
      var
        /*<<fs.js 111 11>>*/ comp_e_=
         /*<<fs.js 111 13>>*/ name_a_.split(str_I_),
     ...
     {this.content={};
      this.inode=file_inode_ak_++;
       /*<<fs.js 31 26>>*/ var now_a_= /*<<fs.js 31 28>>*/ unix_time_z_();
      this.atime=now_a_;
      this.mtime=now_a_;
    ...
    {exists:
     ...
     /*<<fs.js 181 0>>*/ function caml_fs_content_v_(path_a_)
     ...
     /*<<mlString.js 271 0>>*/ function caml_array_of_string_a3_(s_a_)
     { /*<<mlString.js 272 2>>*/ if(s_a_.t!=4)
        /*<<mlString.js 272 28>>*/ caml_convert_string_to_array_ac_(s_a_);
       /*<<mlString.js 273 2>>*/ return s_a_.c /*<<mlString.js 274 0>>*/ }
     /*<<fs.js 133 0>>*/ function caml_fs_register_aI_(name_a_,content_b_)
     {var
       ...
       ( /*<<fs.js 136 11>>*/ var i_k_=0;i_k_<path_f_.length-1;i_k_++)
        ...
        dir_d_= /*<<fs.js 140 10>>*/ dir_d_.get(d_e_);
         /*<<fs.js 141 4>>*/ if(!(dir_d_ instanceof MlDir_j_))
          ...
          (path_f_.orig+str_file_already_abr_u_)}
         ...
         /*<<fs.js 148 7>>*/ if(content_b_ instanceof MlString_h_)
          ...
          /*<<fs.js 149 7>>*/ if(content_b_ instanceof Array)
           ...
           (d_e_,
            new
             MlFile_i_
             ( /*<<fs.js 149 56>>*/ caml_string_of_array_aU_(content_b_)));
         else
     ...
     /*<<fs.js 192 0>>*/ function caml_sys_file_exists_aV_(name_a_)
     {var
     ...
     { /*<<io.js 35 2>>*/ if(caml_global_data_f_.fds===undefined)
      ...
      info_d_.offset=
      flags_c_.append
       ? /*<<io.js 39 29>>*/ caml_ml_string_length_w_(file_b_.data)
       :0;
     ...
     /*<<io.js 45 0>>*/ function caml_sys_open_a4_(name_a_,flags_b_,perms_c_)
     { /*<<io.js 46 8>>*/ var f_d_={};
      ...
      var
       ...
       /*<<io.js 67 2>>*/ if
       ( /*<<io.js 67 6>>*/ caml_sys_file_exists_aV_(name_a_))
        /*<<io.js 67 34>>*/ { /*<<io.js 68 4>>*/ if
         ( /*<<io.js 68 8>>*/ caml_sys_is_directory_aW_(name_a_))
         ...
         /*<<io.js 69 4>>*/ if(f_d_.create&&f_d_.excl)
          ...
          (name2_h_+str_file_already_abr_u_);
        var
          /*<<io.js 70 12>>*/ idx_i_=
          caml_global_data_f_.fd_last_idx?caml_global_data_f_.fd_last_idx:0,
          /*<<io.js 71 13>>*/ file_e_=
           /*<<io.js 71 15>>*/ caml_fs_content_v_(path_j_);
        ...
        /*<<io.js 74 9>>*/ if(f_d_.create)
         /*<<io.js 74 23>>*/ { /*<<io.js 75 12>>*/ var
          idx_i_=
           caml_global_data_f_.fd_last_idx?caml_global_data_f_.fd_last_idx:0;
          /*<<io.js 76 4>>*/ caml_fs_register_aI_
          (name_a_, /*<<io.js 76 26>>*/ caml_create_string_k_(0));
          /*<<io.js 77 13>>*/ var
          file_e_=
            /*<<io.js 77 15>>*/ caml_fs_content_v_(path_j_);
          /*<<io.js 78 4>>*/ return  /*<<io.js 78 11>>*/ caml_sys_open_internal_n_
                 (idx_i_+1,file_e_,f_d_)}
       else
         /*<<io.js 80 7>>*/ caml_raise_no_such_file_ai_(name_a_) /*<<io.js 81 0>>*/ }
     /*<<io.js 82 0>>*/ caml_sys_open_internal_n_
     (0,new MlFile_i_( /*<<io.js 82 36>>*/ caml_create_string_k_(0)));
     /*<<io.js 83 0>>*/ caml_sys_open_internal_n_
     (1,new MlFile_i_( /*<<io.js 83 36>>*/ caml_create_string_k_(0)));
     /*<<io.js 84 0>>*/ caml_sys_open_internal_n_
     (2,new MlFile_i_( /*<<io.js 84 36>>*/ caml_create_string_k_(0)));
     /*<<io.js 153 0>>*/ function caml_ml_open_descriptor_in_aL_(fd_a_)
     ...
     { /*<<mlString.js 376 2>>*/ if(len_e_==0)
       ...
       (i2_d_==0&&(len_e_>=s2_c_.l||s2_c_.t==2&&len_e_>=s2_c_.c.length))
        ...
        s1_a_.t==4
         ? /*<<mlString.js 380 13>>*/ caml_subarray_to_string_x_
        ...
        /*<<mlString.js 383 9>>*/ if(s2_c_.t==2&&i2_d_==s2_c_.c.length)
         ...
         s1_a_.t==4
          ? /*<<mlString.js 385 13>>*/ caml_subarray_to_string_x_
            (s1_a_.c,i1_b_,len_e_)
          :i1_b_==0&&s1_a_.c.length==len_e_
            ?s1_a_.c
         ...
         /*<<mlString.js 388 9>>*/ { /*<<mlString.js 389 4>>*/ if(s2_c_.t!=4)
           /*<<mlString.js 389 31>>*/ caml_convert_string_to_array_ac_(s2_c_);
         var
     ...
     /*<<io.js 129 0>>*/ function caml_ml_open_descriptor_out_ah_(fd_a_)
     {var output_b_;
       /*<<io.js 131 2>>*/ switch(fd_a_)
       {case 1:output_b_=js_print_stdout_a0_; /*<<io.js 132 35>>*/ break;
        case 2:output_b_=js_print_stderr_al_; /*<<io.js 133 35>>*/ break;
        default:output_b_=caml_std_output_aS_}
     ...
     /*<<io.js 99 0>>*/ function caml_ml_out_channels_list_aM_()
     ...
     /*<<stdlib.js 210 0>>*/ function caml_obj_tag_aO_(x_a_)
     { /*<<stdlib.js 210 28>>*/ return x_a_ instanceof Array
              ?x_a_[0]
              :x_a_ instanceof MlString_h_?252:num_1e3_P_ /*<<stdlib.js 210 95>>*/ }
     ...
     /*<<stdlib.js 76 22>>*/ var caml_named_values_aN_={};
     /*<<mlString.js 278 0>>*/ function caml_bytes_of_string_aG_(s_a_)
     ...
     /*<<stdlib.js 80 0>>*/ function caml_register_named_value_aR_(nm_a_,v_b_)
     {caml_named_values_aN_
       [ /*<<stdlib.js 81 20>>*/ caml_bytes_of_string_aG_(nm_a_)]=
      v_b_;
       /*<<stdlib.js 82 2>>*/ return 0 /*<<stdlib.js 83 0>>*/ }
    caml_register_global_b_
     (11,
      [num_248_a_,caml_new_string_c_(str_Undefined_recurs_abr_M_),-12],
      str_Undefined_recurs_abr_M_);
    caml_register_global_b_
     (10,
      [num_248_a_,caml_new_string_c_(str_Assert_failure_H_),-11],
      str_Assert_failure_H_);
    caml_register_global_b_
     (9,
      [num_248_a_,caml_new_string_c_(str_Sys_blocked_io_T_),-10],
      str_Sys_blocked_io_T_);
    caml_register_global_b_
     (8,
      [num_248_a_,caml_new_string_c_(str_Stack_overflow_W_),-9],
      str_Stack_overflow_W_);
    caml_register_global_b_
     (7,
      [num_248_a_,caml_new_string_c_(str_Match_failure_R_),-8],
      str_Match_failure_R_);
    caml_register_global_b_
     (6,[num_248_a_,caml_new_string_c_(str_Not_found_V_),-7],str_Not_found_V_);
    caml_register_global_b_
     (5,
      [num_248_a_,caml_new_string_c_(str_Division_by_zero_Q_),-6],
      str_Division_by_zero_Q_);
    caml_register_global_b_
     (4,
      [num_248_a_,caml_new_string_c_(str_End_of_file_Z_),-5],
      str_End_of_file_Z_);
    caml_register_global_b_
     (3,
      [num_248_a_,caml_new_string_c_(str_Invalid_argument_$_),-4],
      str_Invalid_argument_$_);
    caml_register_global_b_
     (2,[num_248_a_,caml_new_string_c_(str_Failure_Y_),-3],str_Failure_Y_);
    caml_register_global_b_
     (1,[num_248_a_,caml_new_string_c_(str_Sys_error_O_),-2],str_Sys_error_O_);
    caml_register_global_b_
     (0,
      [num_248_a_,caml_new_string_c_(str_Out_of_memory_G_),-1],
      str_Out_of_memory_G_);
    caml_fresh_oo_id_m_(0);
    caml_ml_open_descriptor_in_aL_(0);
    caml_ml_open_descriptor_out_ah_(1);
    caml_ml_open_descriptor_out_ah_(2);
    caml_fresh_oo_id_m_(0);
    caml_fresh_oo_id_m_(0);
    caml_fresh_oo_id_m_(0);
    var
     _A_=[0,0],
     _ap_=caml_new_string_c_("Js.Error"),
     _aq_=caml_new_string_c_("_elm_lang$core$Native_Json.decodePrimitive"),
     _ar_=caml_new_string_c_("string"),
     _at_=caml_new_string_c_("int"),
     _av_=caml_new_string_c_("float"),
     _aw_=caml_new_string_c_("bool"),
     _ay_=caml_new_string_c_("_elm_lang$virtual_dom$Native_VirtualDom.text"),
     _aA_=caml_new_string_c_(str_elm_lang_core_N_abr_X_),
     _az_=caml_new_string_c_(str_elm_lang_core_N_abr_X_),
     _aB_=caml_new_string_c_("button"),
     _aC_=
      [0,caml_new_string_c_(str_target_S_),[0,caml_new_string_c_("value"),0]],
     _aD_=
      [0,
       caml_new_string_c_(str_target_S_),
       [0,caml_new_string_c_("checked"),0]],
     _aE_=caml_new_string_c_("keyCode"),
     _aF_=caml_new_string_c_("Hello World");
    function _B_(_a_){ /*<<?>>*/ _A_[1]=[0,_a_,_A_[1]];return 0}
    var
     _ao_=joo_global_object_y_.Array,
     _C_=[num_248_a_,_ap_,caml_fresh_oo_id_m_(0)],
     _t_=[0,_C_,{}],
     _an_=caml_obj_tag_aO_(_t_)===num_248_a_?_t_:_t_[1];
    caml_register_named_value_aR_(caml_new_string_c_("jsError"),_an_);
    _B_
     (function(_a_)
       { /*<<?>>*/ return _a_[1]===_C_
                ?[0,caml_js_to_string_ag_(_a_[2].toString())]
                :0});
    _B_
     (function(_a_)
       { /*<<?>>*/ return _a_ instanceof _ao_
                ?0
                :[0,caml_js_to_string_ag_(_a_.toString())]});
    function _o_(_a_,_b_){ /*<<?>>*/ return caml_js_expr_aJ_(_a_)(_b_)}
    function _p_(_a_){ /*<<?>>*/ return _o_(_aq_,_a_)}
    var _as_=_p_(_ar_),_au_=_p_(_at_);
    _p_(_av_);
    var _ax_=_p_(_aw_);
    ...
    function _E_(_a_,_b_)
     {var _d_=_b_,_c_=_a_;
      for(;;)
       {if(_c_){var _e_=_c_[2],_d_=_D_(_d_,_c_[1]),_c_=_e_;continue}
        return _d_}}
    _o_(_az_,0);
    _o_(_aA_,0);
    _E_(_aC_,_as_);
      ...
      for(;;)
       {if(_b_)
         {var _c_=_b_[2],_d_=_b_[1];
          try {caml_ml_flush_aK_(_d_)}catch(_f_){}
          var _b_=_c_;
          continue}
        return 0}}
    _am_(caml_ml_out_channels_list_aM_(0));
    return /*<<?>>*/ }
